...
contract GeneInterface {
    ...
    function createGenes(address, uint, bool, uint) external view returns (
    uint16[13] genes
);
...
contract ChibiFighters is ERC721, ContractOwned, CustomEvents {
    ...
    */
    constructor() public {
        ...
        priceFusionChibi = 100;
        // time to become adult
        //adultTime = 3 hours;
        adultTime = 120 seconds;
        //exhaustionTime = 3 hours;
        exhaustionTime = 120 seconds;
        ...
        _infoUrlPrefix = "http://52.11.xxx.xxx/chibis.php?id=";
    }
    ...
    */
    ...
    /**
    * @dev Set game state paused for updates
    ...
    */
    ...
    function mintSpecial(string _name, string _battleRoar, uint8 _region, uint _seed, uint _tokenId) public contract_onlyOwner returns (bool success) {
        // name can be empty
        _mint(_name, _battleRoar, _region, _seed, false, _tokenId);
        return true;
    }
    ...
    * @param _name name of the Chibi
    */
    function _mint(string _name, string _battleRoar, uint8 _region, uint _seed, bool _founder, uint _tokenId) internal {
        ...
        if (_tokenId > 0) {
            dna  = geneContract.createGenes(address(this), _seed, _founder, _tokenId);
        } else {
            dna = geneContract.createGenes(address(this), _seed, _founder, uniqueCounter+1);
        }
